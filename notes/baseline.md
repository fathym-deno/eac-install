...
- jsr:@fathym/common@0.2.292-integration (path, merge, build types)
...
- Golden synaptic notes: pm:@langchain/community@0.3.0, pm:@langchain/core@0.3.1, pm:@langchain/langgraph@0.2.3
...
- Synaptic-focused templates (synaptic, golden-synaptic, sink variants) include npm dependencies: @azure/search-documents@12.1.0, pdf-parse@1.1.1, html-to-text@9.0.5, @langchain suite (core/community/langgraph 0.3.x/0.2.x), and pm:zod
